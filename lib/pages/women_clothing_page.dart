...
class WomenClothingPage extends StatefulWidget {
  const WomenClothingPage({super.key});
  static String womenClothingId = 'WomenClothingPage';

  @override
  State<WomenClothingPage> createState() => _WomenClothingPageState();
}

class _WomenClothingPageState extends State<WomenClothingPage> {
  @override
  void initState() {
