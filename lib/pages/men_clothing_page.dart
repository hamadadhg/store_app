...
class MenClothingPage extends StatefulWidget {
  const MenClothingPage({super.key});
  static String menClothingId = 'MenClothingPage';

  @override
  State<MenClothingPage> createState() => _MenClothingPageState();
}

class _MenClothingPageState extends State<MenClothingPage> {
  @override
  void initState() {
